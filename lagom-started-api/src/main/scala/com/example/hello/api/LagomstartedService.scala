...
object LagomstartedService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-started service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomstartedService.
  */
trait LagomstartedService extends Service {
  ...
  override final def descriptor = {
    ...
    named("lagom-started")
      ...
      .withTopics(
        topic(LagomstartedService.TOPIC_NAME, greetingsTopic _)
